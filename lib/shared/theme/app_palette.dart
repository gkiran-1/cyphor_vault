...
class AppPalette extends ThemeExtension<AppPalette> {
  ...
  static const AppPalette dark = AppPalette(
    ...
    accentDocuments: Color(0xFF10B981),
    accentNotes: Color(0xFFF59E0B),
    accentPasswords: Color(0xFF38BDF8),
    accentPages: Color(0xFFA855F7),
  ...
  static const AppPalette light = AppPalette(
    ...
    accentDocuments: Color(0xFF059669),
    accentNotes: Color(0xFFD97706),
    accentPasswords: Color(0xFF0284C7),
    accentPages: Color(0xFF7C3AED),
    cardVisa: AppColors.cardVisa,
    cardMastercard: AppColors.cardMastercard,
    cardRupay: AppColors.cardRupay,
    cardAmex: AppColors.cardAmex,
